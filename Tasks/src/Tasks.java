...
class Module3 {
    ...
    public static boolean checkPerfect(int
...
class Module5 {
    ...
    public static boolean canMove(String name, String start, String end) {
        ...
        switch (name) {
            ...
            case "Knight": {
                return (Math.abs(startLetter - endLetter) == 2 &&

                        Math.abs(startNumber - endNumber) == 1) || (Math.abs(startLetter - endLetter) == 1 && Math.abs(startNumber - endNumber) == 2);
            }
            case "Bishop": {
